...
function OnEndTurnClicked()
    ...
    if (blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_POLICY or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_RESEARCH or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_FREE_TECH or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_PRODUCTION or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_DIPLO_VOTE or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_FREE_ITEMS or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_FREE_POLICY or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_FOUND_PANTHEON or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_FOUND_RELIGION or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_ENHANCE_RELIGION or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_ADD_REFORMATION_BELIEF or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_STEAL_TECH or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_MAYA_LONG_COUNT or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_FAITH_GREAT_PERSON or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_CITY_RANGE_ATTACK or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_LEAGUE_CALL_FOR_PROPOSALS or blockingType ==
        EndTurnBlockingTypes.ENDTURN_BLOCKING_CHOOSE_ARCHAEOLOGY or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_LEAGUE_CALL_FOR_VOTES or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_CHOOSE_IDEOLOGY) then
    ...
    elseif (blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_STACKED_UNITS or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_UNIT_NEEDS_ORDERS or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_UNITS) then
...
function OnEndTurnRightClicked()
    ...
    if (blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_RESEARCH or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_FREE_TECH or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_PRODUCTION or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_FREE_ITEMS or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_DIPLO_VOTE or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_FOUND_PANTHEON or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_FOUND_RELIGION or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_ENHANCE_RELIGION or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_ADD_REFORMATION_BELIEF or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_STEAL_TECH or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_MAYA_LONG_COUNT or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_FAITH_GREAT_PERSON or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_LEAGUE_CALL_FOR_PROPOSALS or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_CHOOSE_ARCHAEOLOGY or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_LEAGUE_CALL_FOR_VOTES or blockingType ==
        EndTurnBlockingTypes.ENDTURN_BLOCKING_CHOOSE_IDEOLOGY) then
        UI.ActivateNotification(blockingNotificationIndex);
    elseif (blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_POLICY) then
        UI.RemoveNotification(blockingNotificationIndex);
	elseif (blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_FREE_POLICY) then
        UI.RemoveNotification(blockingNotificationIndex);
    elseif (blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_UNIT_PROMOTION) then
        for v in player:Units() do
            if (v:IsPromotionReady()) then
