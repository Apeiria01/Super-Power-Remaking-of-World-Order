...
function OnNotificationAdded( Id, type, toolTip, strSummary, iGameValue, iExtraGameData, ePlayer )
    ...
    and (iGameValue == GameInfoTypes["RESOURCE_MANPOWER"] or iGameValue == GameInfoTypes["RESOURCE_CONSUMER"] or iGameValue == GameInfoTypes["RESOURCE_ELECTRICITY"]
    or   iGameValue == GameInfoTypes["RESOURCE_OTHER_MODS"] or iGameValue == GameInfoTypes["RESOURCE_LOAD"] or iGameValue == GameInfoTypes["RESOURCE_TROOPS"]))
    ...
    then
		...
		if     type == NotificationTypes.NOTIFICATION_WONDER_COMPLETED_ACTIVE_PLAYER then
		...
		elseif type == NotificationTypes.NOTIFICATION_WONDER_COMPLETED
		...
		then
			...
			if iExtraGameData ~= -1 then
				...
				CivIconHookup( 64, 45, instance.CivIcon, instance.CivIconBG, instance.CivIconShadow, false, true );
			end
		...
		elseif type == NotificationTypes.NOTIFICATION_RELIGION_FOUNDED
		or     type == NotificationTypes.NOTIFICATION_RELIGION_ENHANCED
		or     type == NotificationTypes.NOTIFICATION_REFORMATION_BELIEF_ADDED
		then
			if iGameValue ~= -1 then
				local portraitIndex = GameInfo.Religions[iGameValue].PortraitIndex;
				if portraitIndex ~= -1 then
					IconHookup( portraitIndex, 24, GameInfo.Religions[iGameValue].IconAtlas, instance.ReligionIcon );
				end
			else
				instance.ReligionIcon:SetHide(true);
			end
			if iExtraGameData ~= -1 then
				CivIconHookup( iExtraGameData, 45, instance.CivIcon, instance.CivIconBG, instance.CivIconShadow, false, true );
				instance.ReligionSmallCivFrame:SetHide(false);
			end
		elseif type == NotificationTypes.NOTIFICATION_RELIGION_FOUNDED_ACTIVE_PLAYER
		or     type == NotificationTypes.NOTIFICATION_RELIGION_ENHANCED_ACTIVE_PLAYER
		or     type == NotificationTypes.NOTIFICATION_REFORMATION_BELIEF_ADDED_ACTIVE_PLAYER
		then
			if iGameValue == -1 and ePlayer ~= -1 then
				iGameValue = Players[ePlayer]:GetReligionCreatedByPlayer();
			end
			if iGameValue ~= -1 then
				local portraitIndex = GameInfo.Religions[iGameValue].PortraitIndex;
				if portraitIndex ~= -1 then
		...
		elseif type == NotificationTypes.NOTIFICATION_CAPITAL_RECOVERED then
			if iExtraGameData ~= -1 then
				CivIconHookup( iExtraGameData, 45, instance.CivIcon, instance.CivIconBG, instance.CivIconShadow, false, true );
				instance.CapitalRecoveredSmallCivFrame:SetHide(false);
			else
				CivIconHookup( 64, 45, instance.CivIcon, instance.CivIconBG, instance.CivIconShadow, false, true );
				instance.CapitalRecoveredSmallCivFrame:SetHide(true);
			end
		...
		elseif type == NotificationTypes.NOTIFICATION_GREAT_PERSON_ACTIVE_PLAYER then
			...
			if iExtraGameData ~= -1 then
				CivIconHookup( iExtraGameData, 45, instance.CivIcon, instance.CivIconBG, instance.CivIconShadow, false, true );
				instance.GreatPersonSmallCivFrame:SetHide(false);
			else
		...
		elseif type == NotificationTypes.NOTIFICATION_WAR_ACTIVE_PLAYER then
			...
			if iExtraGameData == -1 then
				...
				instance.WarCountCiv:SetHide(true);
				instance.CivSmallFrame:SetHide(true);
			else
				local portraitIndex = GameInfo.Civilizations[iExtraGameData].PortraitIndex;
				IconHookup( portraitIndex, 80, GameInfo.Civilizations[iExtraGameData].IconAtlas, instance.WarCountCiv );
				CivIconHookup( index, 45, instance.CivIconSmall, instance.CivIconSmallBG, instance.CivIconSmallShadow, false, true );
				instance.CivIconBG:SetHide(true);
				instance.WarCountCiv:SetHide(false);
				instance.CivSmallFrame:SetHide(false);
			end
		...
		elseif type == NotificationTypes.NOTIFICATION_PEACE_ACTIVE_PLAYER then
			...
			if iExtraGameData == -1 then
				...
				instance.CivIconBG:SetHide(false);
				instance.PeaceCountCiv:SetHide(true);
				instance.CivSmallFrame:SetHide(true);
			else
				local portraitIndex = GameInfo.Civilizations[iExtraGameData].PortraitIndex;
				IconHookup( portraitIndex, 80, GameInfo.Civilizations[iExtraGameData].IconAtlas, instance.PeaceCountCiv );
				CivIconHookup( index, 45, instance.CivIconSmall, instance.CivIconSmallBG, instance.CivIconSmallShadow, false, true );
				instance.CivIconBG:SetHide(true);
				instance.PeaceCountCiv:SetHide(false);
				instance.CivSmallFrame:SetHide(false);
			end
