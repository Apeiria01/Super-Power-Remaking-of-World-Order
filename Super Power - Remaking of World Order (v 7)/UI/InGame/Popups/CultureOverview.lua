			...
			if (iPlayer ~= g_iSelectedPlayerID) then
				...
				if (iInfluenceLevel ~= InfluenceLevelTypes.NO_INFLUENCE_LEVEL) then
					...
					elseif (iInfluenceLevel == 1) then
						...
						if CheckMoveOutCounter then
							playerInfluence.LevelToolTip = playerInfluence.LevelToolTip .. Locale.ConvertTextKey("TXT_KEY_CO_INFLUENCE_BONUSES_IMMIGRATION", 1);
						end
					elseif (iInfluenceLevel == 2) then
						...
						if CheckMoveOutCounter then
							playerInfluence.LevelToolTip = playerInfluence.LevelToolTip .. Locale.ConvertTextKey("TXT_KEY_CO_INFLUENCE_BONUSES_IMMIGRATION", 2);
						end
					elseif (iInfluenceLevel == 3) then
						...
						if CheckMoveOutCounter then
							playerInfluence.LevelToolTip = playerInfluence.LevelToolTip .. Locale.ConvertTextKey("TXT_KEY_CO_INFLUENCE_BONUSES_IMMIGRATION", 3);
						end
					elseif (iInfluenceLevel == 4) then
						...
						if CheckMoveOutCounter then
							playerInfluence.LevelToolTip = playerInfluence.LevelToolTip .. Locale.ConvertTextKey("TXT_KEY_CO_INFLUENCE_BONUSES_IMMIGRATION", 4);
						end
					else
						playerInfluence.LevelToolTip = Locale.ConvertTextKey("TXT_KEY_CO_INFLUENCE_BONUSES_DOMINANT");
						if CheckMoveOutCounter then
							playerInfluence.LevelToolTip = playerInfluence.LevelToolTip .. Locale.ConvertTextKey("TXT_KEY_CO_INFLUENCE_BONUSES_IMMIGRATION", 5);
						end
					end
