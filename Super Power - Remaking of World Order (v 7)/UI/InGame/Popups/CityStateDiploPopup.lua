...
function PopulateTakeChoices()	
	...
	iBullyGoldInfluenceLost = pPlayer:GetMinorBullyInfluenceLoss(iActivePlayer, iBullyGoldInfluenceLost);
	iBullyUnitInfluenceLost = pPlayer:GetMinorBullyInfluenceLoss(iActivePlayer, iBullyUnitInfluenceLost);
