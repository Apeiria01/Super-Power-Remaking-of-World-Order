...
function OnPopup( popupInfo )
	...
	local iExtraGift = popupInfo.Data3;
	...
	if (iExtraGift > 0) then
		if (iGoldGift > 0) then
			strGiftString = strGiftString .. " ";
		end

		local strExtraGiftString = "TXT_KEY_CITY_STATE_GIFT_"
		local iTrait = pPlayer:GetMinorCivTrait();
		if (iTrait == MinorCivTraitTypes.MINOR_CIV_TRAIT_CULTURED) then
			strExtraGiftString = strExtraGiftString .. "CULTURE"
		elseif (iTrait == MinorCivTraitTypes.MINOR_CIV_TRAIT_MILITARISTIC) then
			strExtraGiftString = strExtraGiftString .. "MILITARY"
		elseif (iTrait == MinorCivTraitTypes.MINOR_CIV_TRAIT_MARITIME) then
			strExtraGiftString = strExtraGiftString .. "FOOD"
		elseif (iTrait == MinorCivTraitTypes.MINOR_CIV_TRAIT_MERCANTILE) then
			strExtraGiftString = strExtraGiftString .. "GOLD"
		elseif (iTrait == MinorCivTraitTypes.MINOR_CIV_TRAIT_RELIGIOUS) then
			strExtraGiftString = strExtraGiftString .. "FAITH"
		end
		
		if (bFirstMajorCiv) then
			strGiftString = strGiftString .. Locale.ConvertTextKey(strExtraGiftString .. "_FIRST", iExtraGift);
		else
			strGiftString = strGiftString .. Locale.ConvertTextKey(strExtraGiftString .. "_OTHER", iExtraGift);
		end
	end
