		...
		if (self.m_IsSelected) then
			...
			if self.m_GroupControls then
				if not self.m_IsInGroup then
					self.m_GroupControls.UISTButton:SetText("[ICON_SGM_GROUP_FIX_OFF]");
					self.m_GroupControls.UISTButton:LocalizeAndSetToolTip("TXT_KEY_SGM_GROUP_FIX_OFF_TT");
				else
					self.m_GroupControls.UISTButton:SetText("[ICON_SGM_GROUP_FIX_ON]");
					self.m_GroupControls.UISTButton:LocalizeAndSetToolTip("TXT_KEY_SGM_GROUP_FIX_ON_TT");
				end
				self.m_GroupControls.GACTButton:SetText("[ICON_SGM_GROUP_FIX_ACT_OFF]");
				self.m_GroupControls.GALLButton:SetText("[ICON_SGM_GROUP_FIX_ALL_OFF]");
				self.m_GroupControls.GACTButton:LocalizeAndSetToolTip("TXT_KEY_SGM_GROUP_FIX_ACT_OFF_TT");
				self.m_GroupControls.GALLButton:LocalizeAndSetToolTip("TXT_KEY_SGM_GROUP_FIX_ALL_OFF_TT");
	...
	UnitMove = function(self, posX, posY, posZ)
		...
		then
			...
			if not g_IsDoingGG and self.m_Escort ~= pUnit:GetPlot() then
				g_IsDoingGG = true;
			elseif g_IsDoingGG and self.m_Escort == pUnit:GetPlot() and not false then
				g_IsDoingGG = false;
			end
		end
			...
			if pAirUnit:GetDomainType() == DomainTypes.DOMAIN_AIR and not pAirUnit:IsInvisible(Game.GetActiveTeam()) then
				...
				if (pAirUnit:GetOwner() ~= Game.GetActivePlayer()) then
					...
					if not GameInfo.Units[pAirUnit:GetUnitType()].Suicide then
						afCount = afCount + 1;
						-- controlTable.GroupMark:RegisterCallback(Mouse.eLClick, function() ; end);
...
function OnUISTClicked(playerID, unitID)
	...
	if pFlag.m_IsInGroup then
		pFlag.m_GroupControls.UISTButton:SetText("[ICON_SGM_GROUP_FIX_ON]");
		pFlag.m_GroupControls.UISTButton:LocalizeAndSetToolTip("TXT_KEY_SGM_GROUP_FIX_ON_TT");
	else
		pFlag.m_GroupControls.UISTButton:SetText("[ICON_SGM_GROUP_FIX_OFF]");
		pFlag.m_GroupControls.UISTButton:LocalizeAndSetToolTip("TXT_KEY_SGM_GROUP_FIX_OFF_TT");
	end
end
...
function OnGACTClicked(playerID, unitID)
	...
	if not pFlag.m_IsInGroup then
		pFlag.m_GroupControls.UISTButton:SetText("[ICON_SGM_GROUP_FIX_OFF]");
		pFlag.m_GroupControls.GACTButton:SetText("[ICON_SGM_GROUP_FIX_ACT_OFF]");
		pFlag.m_GroupControls.GALLButton:SetText("[ICON_SGM_GROUP_FIX_ALL_OFF]");
		pFlag.m_GroupControls.UISTButton:LocalizeAndSetToolTip("TXT_KEY_SGM_GROUP_FIX_OFF_TT");
		pFlag.m_GroupControls.GACTButton:LocalizeAndSetToolTip("TXT_KEY_SGM_GROUP_FIX_ACT_OFF_TT");
		pFlag.m_GroupControls.GALLButton:LocalizeAndSetToolTip("TXT_KEY_SGM_GROUP_FIX_ALL_OFF_TT");
	else
		pFlag.m_GroupControls.UISTButton:SetText("[ICON_SGM_GROUP_FIX_ON]");
		pFlag.m_GroupControls.GACTButton:SetText("[ICON_SGM_GROUP_FIX_ACT_ON]");
		pFlag.m_GroupControls.GALLButton:SetText("[ICON_SGM_GROUP_FIX_ALL_OFF]");
		pFlag.m_GroupControls.UISTButton:LocalizeAndSetToolTip("TXT_KEY_SGM_GROUP_FIX_ON_TT");
		pFlag.m_GroupControls.GACTButton:LocalizeAndSetToolTip("TXT_KEY_SGM_GROUP_FIX_ALL_ON_TT");
		pFlag.m_GroupControls.GALLButton:LocalizeAndSetToolTip("TXT_KEY_SGM_GROUP_FIX_ALL_OFF_TT");
	end
end
...
function OnGALLClicked(playerID, unitID)
	...
	if not pFlag.m_IsInGroup then
		...
		pFlag.m_GroupControls.UISTButton:SetText("[ICON_SGM_GROUP_FIX_ON]");
		pFlag.m_GroupControls.GACTButton:SetText("[ICON_SGM_GROUP_FIX_ACT_OFF]");
		pFlag.m_GroupControls.GALLButton:SetText("[ICON_SGM_GROUP_FIX_ALL_ON]");
		pFlag.m_GroupControls.UISTButton:LocalizeAndSetToolTip("TXT_KEY_SGM_GROUP_FIX_ON_TT");
		pFlag.m_GroupControls.GACTButton:LocalizeAndSetToolTip("TXT_KEY_SGM_GROUP_FIX_ACT_OFF_TT");
		pFlag.m_GroupControls.GALLButton:LocalizeAndSetToolTip("TXT_KEY_SGM_GROUP_FIX_ALL_ON_TT");
	end
end
