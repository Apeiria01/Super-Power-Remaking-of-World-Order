...
function ShowHideCivilopediaButton()
	local bDisable = g_fCountdownTimer ~= -1; -- Disable the save game button while the countdown is active.
	local bShow = true;
	Controls.CivilopediaButton:SetHide(not bShow);
  if( bDisable ) then
		Controls.CivilopediaButton:SetDisabled( true );
		Controls.CivilopediaButton:SetAlpha( 0.5 );
	else
		Controls.CivilopediaButton:SetDisabled( false );
		Controls.CivilopediaButton:SetAlpha( 1.0 );
  end
end
-------------------------------------------------
-------------------------------------------------
