...
SettlerMissionButton = {
    ...
    Action = function(action, unit, eClick)
        ...
        city:SendAndExecuteLuaFunction("CvLuaCity::lChangePopulation", unit:GetExtraPopConsume(), true)
...
WorkerToMilitiaButton = {
    ...
    Action = function(action, unit, eClick)
        ...
        local NewUnit = player:SendAndExecuteLuaFunction(player.InitUnit, player:GetCivUnitNowTech(GameInfoTypes.UNITCLASS_WARRIOR), plotX, plotY, UNITAI_DEFENSE)
        ...
        --Multiplayer game temp fix: abolish human's AI bonus
        for row in DB.Query("SELECT ID FROM Policies WHERE Type LIKE 'POLICY_AI_%';") do 	
            player:SendAndExecuteLuaFunction("CvLuaPlayer::lSetHasPolicy", row.ID, false )
        end
    end
};
...
MilitiaToWorkerButton = {
    ...
    Action = function(action, unit, eClick)
        ...
        local NewUnit = player:SendAndExecuteLuaFunction("CvLuaPlayer::lInitUnit", player:GetCivUnitWithDefault(GameInfoTypes.UNITCLASS_WORKER), plotX, plotY, UNITAI_WORKER)
...
UnitFastMoveMentnButton = {
    ...
    Action = function(action, unit, eClick)
        ...
        unit:SendAndExecuteLuaFunction("CvLuaUnit::lSetHasPromotion", GameInfoTypes["PROMOTION_RAPID_MARCH"], true)
...
UnitFullAttackOnButton = {
    ...
    Action = function(action, unit, eClick)
        ...
        unit:SendAndExecuteLuaFunction("CvLuaUnit::lSetHasPromotion", GameInfoTypes["PROMOTION_FULL_FIRE"], true)
...
UnitFullAttackOffButton = {
    ...
    Action = function(action, unit, eClick)
        ...
        unit:SendAndExecuteLuaFunction("CvLuaUnit::lSetHasPromotion", GameInfoTypes["PROMOTION_FULL_FIRE"], false)
        -- unit:SetMoves(0)
                ...
                if pThisTeam:IsAtWar(iOurTeam) then
                    for city in player:Cities() do
                        if iMaxHitPoint > 0 then
                            ...
                            city:SendAndExecuteLuaFunction("CvLuaCity::lSetDamage", iMaxHitPoint)
                        else
                            --city:SetDamage(city:GetMaxHitPoints())
                            city:SendAndExecuteLuaFunction("CvLuaCity::lSetDamage", city:GetMaxHitPoints())
                        end
                        bHasTarget = true
                    end
                end
    ...
    Action = function(action, unit, eClick)
		...
		then
            if tUnit:GetUnitType() == nUnit:GetUnitType() then
                ...
                tUnit:SendAndExecuteLuaFunction("CvLuaUnit::lSetMaxHitPointsChangeFromRazedCityPop", HPFromRazedCityPop)
                ...
                tUnit:SendAndExecuteLuaFunction("CvLuaUnit::lSetCombatStrengthChangeFromKilledUnits", tUnit:GetCombatStrengthChangeFromKilledUnits()+nUnit:GetCombatStrengthChangeFromKilledUnits())
                ...
                tUnit:SendAndExecuteLuaFunction("CvLuaUnit::lSetRangedCombatStrengthChangeFromKilledUnits", tUnit:GetRangedCombatStrengthChangeFromKilledUnits()+nUnit:GetRangedCombatStrengthChangeFromKilledUnits())
            ...
            if tUnit:IsHasPromotion(GameInfoTypes["PROMOTION_CORPS_1"]) then
                ...
                if unit:IsCanEstablishCorps() then
                    ...
                    player:SendAndExecuteLuaFunction("CvLuaPlayer::lChangeNumArmeeTotalTimes100", 100);
                end
            else
                ...
                if unit:IsCanEstablishCorps() then
                    ...
                    player:SendAndExecuteLuaFunction("CvLuaPlayer::lChangeNumCropsTotalTimes100", 100);
                end
            end
            --tUnit:SetMoves(0);
            ...
            if tUnit ~= unit and nUnit ~= unit then
                ...
                unit:SendAndExecuteLuaFunction("CvLuaUnit::lChangeNumEstablishCorps",-1)
                --unit:SetMoves(0);
                unit:SendAndExecuteLuaFunction("CvLuaUnit::lSetMoves",0)
            end
        end
...
MoralBoostButton = {
    ...
    Action = function(action, unit, eClick)
        ...
        unit:SendAndExecuteLuaFunction("CvLuaUnit::lClearSamePlotPromotions")
        print("Moral Boost!")
        --unit:SetMoves(0)
        unit:SendAndExecuteLuaFunction("CvLuaUnit::lSetMoves", 0)
    end
...
BuildMilitaryAcademyButton = {
    ...
    Action = function(action, unit, eClick)
        ...
        city:SendAndExecuteLuaFunction(city.SetNumRealBuilding, GameInfoTypes["BUILDING_MILITARY_ACADEMY"], 1)
