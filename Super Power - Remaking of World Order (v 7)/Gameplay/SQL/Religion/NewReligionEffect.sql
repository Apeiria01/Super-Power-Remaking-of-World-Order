...
SELECT 'BELIEF_GOD_OF_COMMERCE','RESOURCE_IVORY','YIELD_GOLDEN_AGE_POINTS',3 UNION ALL
SELECT 'BELIEF_GOD_OF_COMMERCE','RESOURCE_TRUFFLES','YIELD_GOLD',3 UNION ALL
SELECT 'BELIEF_GOD_OF_COMMERCE','RESOURCE_TRUFFLES','YIELD_GOLDEN_AGE_POINTS',3 UNION ALL
SELECT 'BELIEF_GOD_OF_COMMERCE','RESOURCE_FUR','YIELD_GOLD',3 UNION ALL
SELECT 'BELIEF_GOD_OF_COMMERCE','RESOURCE_FUR','YIELD_GOLDEN_AGE_POINTS',3 ;
