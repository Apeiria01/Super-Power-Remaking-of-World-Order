...
SELECT 'POLICY_ARISTOCRACY',    'YIELD_FOOD',       1 UNION ALL
SELECT 'POLICY_ARISTOCRACY',    'YIELD_PRODUCTION', 1 UNION ALL
SELECT 'POLICY_LEGALISM',       'YIELD_FOOD',       1 UNION ALL
SELECT 'POLICY_LEGALISM',       'YIELD_PRODUCTION', 1 UNION ALL
SELECT 'POLICY_LANDED_ELITE',   'YIELD_FOOD',       1 UNION ALL
SELECT 'POLICY_LANDED_ELITE',   'YIELD_PRODUCTION', 1 UNION ALL
SELECT 'POLICY_OLIGARCHY',      'YIELD_FOOD',       1 UNION ALL
SELECT 'POLICY_OLIGARCHY',      'YIELD_PRODUCTION', 1 UNION ALL
SELECT 'POLICY_PREFECTURE',     'YIELD_FOOD',       1 UNION ALL
SELECT 'POLICY_PREFECTURE',     'YIELD_PRODUCTION', 1 UNION ALL
SELECT 'POLICY_FAMILY_REGISTER','YIELD_FOOD',       1 UNION ALL
SELECT 'POLICY_FAMILY_REGISTER','YIELD_PRODUCTION', 1 UNION ALL
SELECT 'POLICY_CENTRALISATION', 'YIELD_FOOD',       1 UNION ALL
SELECT 'POLICY_CENTRALISATION', 'YIELD_PRODUCTION', 1 UNION ALL
SELECT 'POLICY_MONARCHY',       'YIELD_FOOD',       1 UNION ALL
SELECT 'POLICY_MONARCHY',       'YIELD_PRODUCTION', 1;
