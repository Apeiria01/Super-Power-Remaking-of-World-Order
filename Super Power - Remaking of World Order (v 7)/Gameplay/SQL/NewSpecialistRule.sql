...
CREATE TRIGGER IF NOT EXISTS SP_AdjacentImprovementYieldChangesForNewImproments
...
SELECT 'BUILDING_SPECIALISTS_ENGINEERING_LV3','SPECIALIST_ENGINEER','YIELD_PRODUCTION';

INSERT INTO Building_SpecialistYieldChanges(BuildingType,SpecialistType,YieldType,Yield)
SELECT BuildingType, SpecialistType, YieldType, 2
...
INSERT INTO Building_SpecialistYieldChanges(BuildingType,SpecialistType,YieldType,Yield)
SELECT 'BUILDING_SPECIALISTS_SCIENTIFIC_LV1','SPECIALIST_SCIENTIST','YIELD_SCIENCE', 1 UNION ALL
SELECT 'BUILDING_SPECIALISTS_SCIENTIFIC_LV1','SPECIALIST_SCIENTIST','YIELD_GOLD', -1 UNION ALL
SELECT 'BUILDING_SPECIALISTS_MERCHANT_LV1','SPECIALIST_MERCHANT','YIELD_GOLD', 2 UNION ALL
SELECT 'BUILDING_SPECIALISTS_MERCHANT_LV2','SPECIALIST_MERCHANT','YIELD_FOOD', 1 UNION ALL
SELECT 'BUILDING_SPECIALISTS_MERCHANT_LV3','SPECIALIST_MERCHANT','YIELD_FOOD', 1;
...
('SPECIALIST_MERCHANT', 'RESOURCE_CONSUMER', 3, 'POLICY_CAPITALISM', null),
