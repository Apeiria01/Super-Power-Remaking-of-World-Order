...
SELECT Type, 'BUILDINGCLASS_VENICE_ARMORY', 'YIELD_PRODUCTION', 2 FROM Policies Where PolicyBranchType = 'POLICY_BRANCH_EXPLORATION' UNION ALL
SELECT Type, 'BUILDINGCLASS_VENICE_ARMORY', 'YIELD_SCIENCE', 2 FROM Policies Where PolicyBranchType = 'POLICY_BRANCH_EXPLORATION' UNION ALL
SELECT 'POLICY_EXPLORATION_FINISHER', 'BUILDINGCLASS_VENICE_ARMORY', 'YIELD_PRODUCTION', 3 UNION ALL
SELECT 'POLICY_EXPLORATION_FINISHER', 'BUILDINGCLASS_VENICE_ARMORY', 'YIELD_SCIENCE', 3;